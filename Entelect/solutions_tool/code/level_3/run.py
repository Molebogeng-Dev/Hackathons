#!/usr/bin/env python3
"""
Photospheria Level 3: Park Potential Solver & Evaluator
"""
import argparse
import json
import os
...
def main():
    parser = argparse.ArgumentParser(description="Photospheria Level 3 Solver & Evaluator")
    parser.add_argument("--level", default="3.json", help="Path to level map JSON (default: 3.json)")
    ...
    print("=" * 60)
    print("       LEVEL 3: PARK POTENTIAL SCORE REPORT          ")
    print("=" * 60)
    ...
    print(f"\n[Saved Level 3 solution to {out_path} (mode: {args.key_mode})]")
