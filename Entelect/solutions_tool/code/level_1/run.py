#!/usr/bin/env python3
"""
Photospheria Level 1: Greenhouse Study Solver & Evaluator
"""
import argparse
import json
import os
...
def main():
    parser = argparse.ArgumentParser(description="Photospheria Level 1 Solver & Evaluator")
    parser.add_argument("--level", default="1.json", help="Path to level map JSON (default: 1.json)")
    ...
    print("=" * 60)
    print("       LEVEL 1: GREENHOUSE STUDY SCORE REPORT        ")
    print("=" * 60)
    ...
    print(f"\n[Saved Level 1 solution to {out_path} (mode: {args.key_mode})]")
