#!/usr/bin/env python3
"""
Photospheria Level 2: Garden Growth Study Solver & Evaluator
"""
import argparse
import json
import os
...
def main():
    parser = argparse.ArgumentParser(description="Photospheria Level 2 Solver & Evaluator")
    parser.add_argument("--level", default="2.json", help="Path to level map JSON (default: 2.json)")
    ...
    print("=" * 60)
    print("       LEVEL 2: GARDEN GROWTH STUDY SCORE REPORT     ")
    print("=" * 60)
    ...
    print(f"\n[Saved Level 2 solution to {out_path} (mode: {args.key_mode})]")
